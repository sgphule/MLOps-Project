...
def main():
    try:
        # Fetch the data from artifact/raw
        train_data = pd.read_csv('./artifact/raw/train.csv')
        test_data = pd.read_csv('./artifact/raw/test.csv')
        ...
        # Store the data inside artifact/interim
        data_path = os.path.join("./artifact", "interim")
