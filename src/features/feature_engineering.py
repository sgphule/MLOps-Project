...
def main():
    try:
        ...
        train_data = load_data('./artifact/interim/train_processed.csv')
        test_data = load_data('./artifact/interim/test_processed.csv')

        train_df, test_df = apply_bow(train_data, test_data, max_features)

        save_data(train_df, os.path.join("./artifact", "processed", "train_bow.csv"))
        save_data(test_df, os.path.join("./artifact", "processed", "test_bow.csv"))
    except Exception as e:
